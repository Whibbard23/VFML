...
class EventAnnotator:
    ...
    def draw(self):
        ...
        cv2.putText(self.frame_display, "Tab/1/2 switch | +/- resize | v toggle active ROI vis | V toggle both ROIs | r replace | u undo | p saved | b back | < > step | B bolus | n next | N next video | s save | q quit",
